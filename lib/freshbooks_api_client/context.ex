defmodule FreshbooksApiClient.Context do
  ...
  def list_clients() do
    FreshbooksApiClient.Api.all(FreshbooksApiClient.Interface.Clients)
  end

  def get_client!(client_id) do
    FreshbooksApiClient.Api.call(FreshbooksApiClient.Interface.Clients, :get!, [client_id: client_id])
  end

  # https://www.freshbooks.com/developers/docs/invoices#invoice.list
  def list_invoices(date: date) do
    date = Date.to_iso8601(date)
    FreshbooksApiClient.Api.all(FreshbooksApiClient.Interface.Invoices, [date_from: date, date_to: date])
  end

  def get_invoice!(invoice_id) do
    FreshbooksApiClient.Api.call(FreshbooksApiClient.Interface.Invoices, :get!, [invoice_id: invoice_id])
  end

  # https://www.freshbooks.com/developers/docs/projects#project.list
  def list_projects() do
    FreshbooksApiClient.Api.all(FreshbooksApiClient.Interface.Projects)
  end

  def get_project!(project_id) do
    FreshbooksApiClient.Api.call(FreshbooksApiClient.Interface.Projects, :get!, [project_id: project_id])
  end

  # https://www.freshbooks.com/developers/docs/staff#staff.list
  def list_staff() do
    FreshbooksApiClient.Api.all(FreshbooksApiClient.Interface.Staff)
  end

  def get_staff!(staff_id) do
    FreshbooksApiClient.Api.call(FreshbooksApiClient.Interface.Staff, :get!, [staff_id: staff_id])
  end
  ...
  def list_tasks() do
    FreshbooksApiClient.Api.all(FreshbooksApiClient.Interface.Tasks)
  end

  def get_task!(task_id) do
    FreshbooksApiClient.Api.call(FreshbooksApiClient.Interface.Tasks, :get!, [task_id: task_id])
  end

  # https://www.freshbooks.com/developers/docs/time-entries#time_entry.list
  def list_time_entries(date: date) do
    date = Date.to_iso8601(date)
    FreshbooksApiClient.Api.all(FreshbooksApiClient.Interface.TimeEntries, [date_from: date, date_to: date])
  end

  def get_time_entry!(time_entry_id) do
    FreshbooksApiClient.Api.call(FreshbooksApiClient.Interface.TimeEntries, :get!, [time_entry_id: time_entry_id])
  end
